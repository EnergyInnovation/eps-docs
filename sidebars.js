  ...
  epsSidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        { type: 'doc', id: 'january-2025-frozen-policies-federal', label: 'January 2025 Frozen Policies' },
        { type: 'doc', id: 'january-2025-frozen-policies-state', label: 'January 2025 Frozen Policies (States)' },
    ...
    },
    {
      ...
      items: [
        [
          ...
          { type: 'doc', id: 'models/anhui', label: 'Anhui' },
          { type: 'doc', id: 'models/anhui_zh', label: 'Anhui — 中文' },
          ...
          { type: 'doc', id: 'models/china', label: 'China (NCSC)' },
          ...
          { type: 'doc', id: 'models/shandong_zh', label: 'Shandong — 中文' },
          { type: 'doc', id: 'models/shanxi', label: 'Shanxi' },
          { type: 'doc', id: 'models/shanxi_zh', label: 'Shanxi — 中文' },
          ...
          { type: 'doc', id: 'models/tianjin_zh', label: 'Tianjin — 中文' },
