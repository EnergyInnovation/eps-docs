...
* Hyojin Kim, NEXT Group
* Jae Hyun Shin, Chungnam National University
* Jiwoo Lee,  NEXT Group
* Joohye Kim, NEXT Group
* Kye Young Lee, NEXT Group
* Mary Francis Swint, Energy Innovation LLC
* Minhee Lee, NEXT Group
...
* Sugang Kim, NEXT Group
* Yonghyun Song, NEXT Group

## Version History

### **4.0.4 - February 2, 2026**

* Updated model platform to 4.0.4 from 3.3.1
* Incorporates extensive data and projection updates across sectors 
* Updated to redesigned electricity module, including hourly demand and dispatch for six time slices.
