...
The Maryland Energy Policy Simulator (EPS) is a free and open-source computer model created by [Energy Innovation LLC](https://energyinnovation.org/) and [RMI](https://rmi.org/).  It is adapted from software originally created by [Energy Innovation LLC](https://energyinnovation.org/).

<p><a href="https://energypolicy.solutions/simulator/maryland/en" class="btn">Run the simulator in your browser</a></p>
...
<p><a href="https://github.com/EnergyInnovation/eps-maryland/archive/refs/tags/4.0.4.zip" class="btn">Download the Maryland Energy Policy Simulator</a></p>

[Click here](https://energypolicy.solutions/simulator/maryland/en/e4b5fc4) for access to the previous version of the public model, including access to saved scenarios.
...
Seth Hoffman<br/>
[https://unsplash.com/photos/Fct4NXOMyVc](https://unsplash.com/photos/Fct4NXOMyVc)<br/>
