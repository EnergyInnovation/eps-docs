...
The Indiana Energy Policy Simulator (EPS) is a free and open-source computer model created by [Energy Innovation LLC](https://energyinnovation.org/) and [RMI](https://rmi.org/).  It is adapted from software originally created by [Energy Innovation LLC](https://energyinnovation.org/).

<p><a href="https://energypolicy.solutions/simulator/indiana/en" class="btn">Run the simulator in your browser</a></p>
...
<p><a href="https://github.com/EnergyInnovation/eps-indiana/archive/refs/tags/4.0.4.zip" class="btn">Download the Indiana Energy Policy Simulator</a></p>

[Click here](https://energypolicy.solutions/simulator/indiana/en/f50d7b9) for access to the previous version of the public model, including access to saved scenarios.
...
## Image Credits
Country road in rural Indiana<br/>
Steven Van Elk<br/>
[https://unsplash.com/photos/CtgEZsJu-vY](https://unsplash.com/photos/CtgEZsJu-vY)<br/>
