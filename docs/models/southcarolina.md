...
The South Carolina Energy Policy Simulator (EPS) is a free and open-source computer model created by [Energy Innovation LLC](https://energyinnovation.org/) and [RMI](https://rmi.org/).  It is adapted from software originally created by [Energy Innovation LLC](https://energyinnovation.org/).

<p><a href="https://energypolicy.solutions/simulator/southcarolina/en" class="btn">Run the simulator in your browser</a></p>
...
<p><a href="https://github.com/EnergyInnovation/eps-southcarolina/archive/refs/tags/4.0.4.zip" class="btn">Download the South Carolina Energy Policy Simulator</a></p>

[Click here](https://energypolicy.solutions/simulator/southcarolina/en/65dc53a) for access to the previous version of the public model, including access to saved scenarios.
...
## Image Credits
Sunset near Kiawah Island, South Carolina on the marsh<br/>
Clint McKoy<br/>
[https://unsplash.com/photos/VFpCU6ia6vU](https://unsplash.com/photos/VFpCU6ia6vU)<br/>
