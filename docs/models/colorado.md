...
[Click here](https://eps-app-git-develop-energy-innovation.vercel.app/simulator/colorado/en/914227e) for access to the previous version of the public model, which was recalibrated to the state's emissions inventory, and used to inform the state's emissions reductions roadmap. 
