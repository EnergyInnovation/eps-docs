...
<p><a href="https://github.com/Energy-Innovation/eps-colorado/archive/refs/tags/3.4.3.zip" class="btn">Download the Colorado Energy Policy Simulator</a></p>

Documentation of source data, assumptions, and policy scenarios is available [here](https://github.com/Energy-Innovation/eps-colorado/blob/main/Colorado%20EPS%20Scenario%20Assumptions.pdf). ## Acknowledgement of Contributors and Reviewers
