...
The Colorado Energy Policy Simulator (EPS) is a free and open-source computer model created by [Energy Innovation LLC](https://energyinnovation.org/) and [RMI](https://rmi.org/).  It is adapted from software originally created by [Energy Innovation LLC](https://energyinnovation.org/).
...
<p><a href="https://github.com/EnergyInnovation/eps-colorado/archive/refs/tags/4.0.6.zip" class="btn">Download the Colorado Energy Policy Simulator</a></p>
