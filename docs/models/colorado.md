...
<p><a href="https://github.com/EnergyInnovation/eps-colorado/archive/refs/tags/3.4.3.8.zip" class="btn">Download the Colorado Energy Policy Simulator</a></p>
...
| --- | --- | --- |
| **Electricity** |- (A) Resource usage necessary to achieve sector targets in HB21-1266<br/> - (B) Funding for geothermal electricity from HB23-1252 grant program and HB23-1272 tax credits<br/> - (C) Xcel retirement of Comanche Unit 3<br/><br/>- <font color='green'>(D) IIJA Section no. 41001 projected to increase storage capacity online by 2026.</font><br/>| - (A) As a proxy and to match the state's modeled emission reductions as a result of Clean Energy Plans, Clean Electricity Standard lever is set to 86% with the implementation schedule ramping up fully from 2022 to 2030.<br/>- (B) Subsidy for geothermal electricity capacity construction set to 14% between 2023 and 2025. Subsidy for electricity production from geothermal set to 3 dollars per MWh for 2024–2032.<br/>- (C) Additional early retirement of 0.75 GW of coal in 2031<br/>- <font color='green'>(D) Grid-Scale Electricity Storage set at 8% with an implementation schedule ramping up to 100% by 2026.</font>|
| **Buildings**   |- (A) Clean Heat Plan legislation in SB21-264, assuming strong compliance<br/>- (B) HB22-1362, which supports development of near-zero energy codes and phases in adoption for public and large buildings<br/>- (C) Utility beneficial electrification plans (SB 21-246)<br/>- (D) Building Performance Colorado, which requires adoption of building performance standard rules for large<br/> commercial buildings to achieve a 7% emissions reduction by 2026 and 20% emissions reduction by 2030 relative to 2021- (E) Appliance standards in HB23-1161<br/> | - (A) Building Component Electrification lever set to 80% for all appliances, with implementation schedule ramping up fully from 2021 to 2030.<br/> - (B) Building Energy Efficiency Standards lever set to 11% for residential buildings. Implementation ramps from 0% to 8% from 2022–2026 to represent upgrading to the 2021 IECC and then increases to full implementation in 2050 to represent upgrading to the low-carbon code.<br/> - (C) Retrofit Existing Buildings lever set to 5% with an implementation schedule that ramps up fully from 2022 to 2038to match emission reductions projected in 2022 Xcel BE Plan.<br/> - (D) 50% efficiency improvement in commercial building stock to achieve a 20% emissions reduction by 2030<br/> - (E) To model HB23-1161, the Building Component Electrification lever (which was set to 80% for all appliances to model SB21-264) is increased to 90% for Heating only, with the implementation schedule is adjusted to reflect HB23-1161 coming into effect in 2026. This decreases total NOx emissions to approximate RMI projections.<br/>|
| **Transportation**   |- (A) Existing state EV tax credit and HB23–1272 extension<br/>- (B) Compliance with 2021 Colorado Department of Transportation (CDOT) rulemaking<br/>- (C) ACT and Low NOx rules for medium and heavy-duty vehicles<br/>- <font color='green'>(D) IRA Section no. 60101 supports addition of clean heavy-duty vehicles</font><br/>- <font color='green'>(E) IIJA Section no. 30018, 71101 supports replacement and addition of school buses with clean vehicles</font><br/>- (F) Compliance with the Advanced Clean Cars (LEV/ZEV) standard in effect and Advanced Clean Cars II rule for passenger vehicles through 2032<br/>- (G) HB23-1281 tax credit for clean hydrogen<br/>- (H) HB23-1272 tax credit for sustainable aviation fuel<br/>- (I) SB21-260 investments in electric vehicle (EV) infrastructure and fleet electrification<br/>- (J) IRA Section no.11101 and 11401 provide grants for charging and fueling infrastructure<br/>|- (A) Electric vehicle subsidy lever set to 13% with an implementation schedule that matches tax credit values from 2020 through 2028<br/>- (B) 9% LDV vehicle miles traveled (VMT) reduction below BAU by 2050 for passenger vehicles<br/>- (C), <font color='green'>(D) & (E)</font> EV Sales Standard lever for Buses, Light Commercial Trucks, and Heavy and Medium Duty Trucks set to 46%. Implementation schedule matches Energy Innovation's modeling of ACT, ramping fully from 2022 to 2035 and holding steady to 2050.<br/>- (F) ACC and ACCII ZEV: EV Sales Standard lever set, for Cars and SUVs, to 82% with implementation schedule that matches ACCII percentages 2026–2032 inclusive. 2032 implementation held constant through 2050. ACCII LEV: Fuel Economy Standard lever set, for Cars and SUVs, to 68% with an implementation schedule ramping up partially from 2020 to 2026 (to match ACC), increasing to full implementation in 2032, and holding steady to 2050 to match the state's % emission reductions from 2026–2032.<br/>- (G) Shift to hydrogen in medium- and heavy-duty vehicles 9% by 2050. Implementation increases from 0% to 12% 2023–2030, and full implementation occurs by 2050, to align with NREL analysis on truck decarbonization pathways.- (H) Linearly decrease in aviation emissions by approximately 10% relative to BAU in 2032 (using mode shifting lever as a proxy for sustainable aviation fuel impact)<br/>- (I) &(J) These policies are not modeled using a lever. Instead, we adjust the model's input data on charging costs underlying the BAU to represent increased funding for chargers.<br/>
 |
| **Industry**   |- (A) Compliance with requirements for oil and gas in AQCC Regulations 7 and 22, extrapolating impacts from APCD and EDF analysis. Note we assume strong compliance with the Intensity Standard for O&G production given in Regulation 22, assuming a robust verification rule<br/>- (B) SB22-198 and Financial Assurance Rules, which provide funding mechanisms for the remediation of orphaned wells<br/>- <font color='green'>(C) IIJA Section no. 40601 funds remediation and plugging of orphaned well sites</font><br/>- (D) State hydrofluorocarbon (HFC) regulations<br/>- (E) GEMM Phase I rulemaking, which requires four heavy-emitting industrial facilities to demonstrate compliance with emissions reductions targets through an audit process<br/>- (F) Completion of the GEMM Phase II rulemaking, which requires about [20 facilities](https://drive.google.com/file/d/1sssHZV--5KpPmSfUcBhe9X3cKoR3svEg/view) to demonstrate compliance with 20% emissions reduction by 2030 relative to 2015<br/>- (G) HB23-1281 tax credit for clean hydrogen<br/>- (H) HB23-1272 tax credits for industrial facility clean energy investments<br/> | - (A), (B), & <font color='green'>(C)</font> Methane capture of 100% by 2030 and Industry Energy Efficiency Standards lever for Oil and Gas Extraction set to 25%. Implementation schedule for both levers ramps up fully from 2022 to 2030. Electrification lever for Oil and Gas extraction set to 90% ramping to 60% by 2030. These are used to approximate the midpoint between the worst-case and best-case emissions abatement scenarios from RMI analysis on the intensity standard in Regulation 22.- (D) F-gas measures are implemented 50% by 2030 and fully by 2040<br/>- (E) & (F) 8% efficiency improvement in industrial energy consumption by 2030 (lever set to match annual expected abatement of 0.5–0.6 MMT CO2e by 2030 for GEMM Phase I and GEMM Phase II)<br/>- (G) Incentive assumed to create demand pull that leads to an industry shift to hydrogen aligned with 5% achievement of NDC pathway, ramping up fully from 2022 to 2050.<br/>- (H) Industry Energy Efficiency lever increased by 5% (adding to the 8% corresponding to GEMM Phase I and GEMM Phase II) for Industry Categories most directly affected by this bill.<br/>|
