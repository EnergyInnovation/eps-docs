---
title:  "Alabama Energy Policy Simulator"
---

The Alabama Energy Policy Simulator (EPS) is a free and open-source computer model created by [Energy Innovation LLC](https://energyinnovation.org/) and [RMI](https://rmi.org/).  It is adapted from software originally created by [Energy Innovation LLC](https://energyinnovation.org/).

<p><a href="https://energypolicy.solutions/simulator/alabama/en" class="btn">Run the simulator in your browser</a></p>
...
The Alabama Energy Policy Simulator may be used on this website through your web browser, or the full version may be downloaded to your computer by clicking the button below.  Note that you will need to go through the steps explained on the [EPS download page](../download) in order to install the required software and make use of the downloadable version of the model.

<p><a href="https://github.com/EnergyInnovation/eps-alabama/archive/refs/tags/4.0.4.zip" class="btn">Download the Alabama Energy Policy Simulator</a></p>

[Click here](https://energypolicy.solutions/simulator/alabama/en/75da1ec) for access to the previous version of the public model, including access to saved scenarios.
...
Bham, Alabama<br/>
Clark Tibbs<br/>
[https://unsplash.com/photos/Dbpr3t_grhU](https://unsplash.com/photos/Dbpr3t_grhU)<br/>
