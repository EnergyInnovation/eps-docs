...
<p><a href="https://github.com/Energy-Innovation/eps-minnesota/archive/3.4.3.zip" class="btn">Download the Minnesota Energy Policy Simulator</a></p>

Documentation of source data, assumptions, and policy scenarios is available [here](https://github.com/Energy-Innovation/eps-minnesota/blob/master/MN%20Policy%20Assumptions_FINAL.pdf). ## Acknowledgement of Contributors and Reviewers
