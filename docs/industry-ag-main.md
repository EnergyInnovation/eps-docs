...
![cement industry potential emis reduction from clinker substitution](/img/industry-ag-main-CementPotential.png)
...
![disaggregation of process emissions changes by pollutant](/img/industry-ag-main-ProcEmisDisagg.png)
...
![total process emissions](/img/industry-ag-main-ProcEmisTotal.png)
...
![fuel switching policy](/img/industry-ag-main-FuelSwitching.png)
...
![change in industrial production levels](/img/industry-ag-main-ChangeInProd.png)
...
![fuel use for CCS](/img/industry-ag-main-CCSFuel.png)
